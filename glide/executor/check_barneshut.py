"""
glide/executor/check_barneshut.py

Validates glide.executor.barneshut against the reference O(N^2) FR step:
...
Usage:
    .venv/bin/python -m glide.executor.check_barneshut
"""
