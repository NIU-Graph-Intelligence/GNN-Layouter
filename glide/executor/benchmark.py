...
Usage:
    .venv/bin/python -m glide.executor.benchmark --n_list 100 1000 10000 --k_geo 10 --T 20
    .venv/bin/python -m glide.executor.benchmark --n_list 100000 --device cuda:0 --T 10
"""
