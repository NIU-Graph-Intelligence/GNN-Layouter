"""
glide/executor/check_data_pipeline.py

Verifies glide/executor/data.py's raw-frame reconstruction and temperature
...
Run: .venv/bin/python -m glide.executor.check_data_pipeline
"""
