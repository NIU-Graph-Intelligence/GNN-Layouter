...
Reuses philayouter/stage1/gst/encodings.py (raw eigenvector/RRWP computation) and
philayouter/stage1/gst/sign_net.py (sign-invariant processing) rather than forking
...
from philayouter.stage1.gst.sign_net import SignNet
...
class StructuralEncoder(nn.Module):
    ...
    def encode_precomputed(self, eigvecs: torch.Tensor, rrwp_node: torch.Tensor = None) -> torch.Tensor:
        ...
        (philayouter/stage1/preprocess_encodings.py) -- reuse them instead of
